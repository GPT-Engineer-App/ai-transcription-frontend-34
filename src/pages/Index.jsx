  ...
  return (
    <Box p={4}>
      ...
      {isLoading ? (
        ...
        <Table variant="simple" border="1px" borderColor="gray.500" borderRadius="lg" borderCollapse="separate !important">
          <Thead>
            <Tr>
              <Th>File Name</Th>
              <Th>Size</Th>
          ...
          <Tbody>
            {files.map((file, index) => (
              <Tr key={file.name} bg={index % 2 === 0 ? "gray.900" : "gray.800"} p={4} mb={4} rounded="lg">
